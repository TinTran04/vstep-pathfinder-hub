...
export const quizzes: Record<Skill, QuizItem[]> = {
  ...
  speaking: [
    { id: 13, title: "Đề thi thử Speaking #1", description: "Tương tác xã hội + thảo luận giải pháp", duration: "12–15 phút", questions: 3, difficulty: "Dễ", isFree: true },
    { id: 14, title: "Đề thi thử Speaking #2", description: "Tương tác xã hội + thảo luận + phát triển chủ đề", duration: "12–15 phút", questions: 3, difficulty: "Trung bình", isFree: true },
    { id: 15, title: "Đề thi thử Speaking #3", description: "Format chuẩn VSTEP đầy đủ 3 phần", duration: "12–15 phút", questions: 3, difficulty: "Khó", isFree: false },
  ],
};
...
export const overviewData: Record<Skill, { structure: { part: string; content: string; questions: string; time: string }[]; tips: string[]; scoring: string }> = {
  listening: {
    structure: [
      { part: "Part 1", content: "Thông báo/hướng dẫn ngắn (8 câu)", questions: "8 câu", time: "~10 phút" },
      { part: "Part 2", content: "3 hội thoại x 4 câu (12 câu)", questions: "12 câu", time: "~15 phút" },
      { part: "Part 3", content: "3 bài nói x 5 câu (15 câu)", questions: "15 câu", time: "~15 phút" },
    ],
  ...
  reading: {
    structure: [
      { part: "Passage 1", content: "Trình độ B1 – Đoạn văn ngắn, chủ đề đời thường", questions: "10 câu", time: "~12 phút" },
      { part: "Passage 2", content: "Trình độ B1/B2 – Bài báo khoa học phổ thông", questions: "10 câu", time: "~15 phút" },
      { part: "Passage 3", content: "Trình độ B2/C1 – Văn bản học thuật chuyên sâu", questions: "10 câu", time: "~15 phút" },
      { part: "Passage 4", content: "Trình độ C1 – Tài liệu nghiên cứu nâng cao", questions: "10 câu", time: "~18 phút" },
    ],
  ...
  writing: {
    structure: [
      { part: "Task 1", content: "Viết thư/email hoặc tóm tắt thông tin (tối thiểu 120 từ)", questions: "1 bài", time: "20 phút" },
      { part: "Task 2", content: "Bài luận 250–300 từ (nghị luận xã hội hoặc giải pháp)", questions: "1 bài", time: "40 phút" },
    ],
  ...
  speaking: {
    structure: [
      { part: "Part 1", content: "Tương tác xã hội – trả lời câu hỏi cá nhân (~8 câu)", questions: "~8 câu", time: "3 phút" },
      { part: "Part 2", content: "Thảo luận giải pháp – chọn 1 trong 3 giải pháp được đề xuất", questions: "1 chủ đề", time: "4 phút" },
      { part: "Part 3", content: "Phát triển chủ đề và trả lời câu hỏi mở rộng (~5 câu)", questions: "~5 câu", time: "5 phút" },
    ],
    tips: ["Part 1: Trả lời tự nhiên, đầy đủ", "Part 2: Thảo luận ưu nhược điểm từng giải pháp, chọn 1", "Part 3: Đưa ra ý kiến và giải thích mở rộng", "Chú ý phát âm và ngữ điệu"],
